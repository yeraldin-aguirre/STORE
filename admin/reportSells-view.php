        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading text-center">
                    <h4>Reportes ventas de la tienda</h4>
                </div>
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            $reportes = mysqli_query($mysqli, "SELECT SQL_CALC_FOUND_ROWS * FROM reporte WHERE tipo LIKE  '%venta%' LIMIT $inicio, $regpagina");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="./report/reporteVent.php?id=<?php echo $repo['id']; ?>" class="btn btn-raised btn-xs btn-primary" target="_blank">Imprimir</a>
                                    </td>
                                </tr>
                            <?php
                                $cr++;
