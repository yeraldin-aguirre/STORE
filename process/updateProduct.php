...
$dimeProdUp = consultasSQL::clean_string($_POST['prod-dime']);
$estruProdUp = consultasSQL::clean_string($_POST['prod-estru']);
...
if (consultasSQL::UpdateSQL("producto", "NombreProd='$nameProdUp',CodigoCat='$catProdUp',Precio='$priceProdUp',Descuento='$descProdUp',Dimension='$dimeProdUp',Estructura='$estruProdUp',Stock='$stockProdUp',NITProveedor='$proveProdUp',Estado='$EstadoProdUp'", "CodigoProd='$codeOldProdUp'")) {
	echo '<script>
			swal({
