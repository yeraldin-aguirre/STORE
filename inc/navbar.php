          ...
          if (!$_SESSION['documentoAdmin'] == "") {
            echo ' 
                              ...
                              <a href="#!" class="table-cell-td exit-system">
                                  <i class="fa fa-user"></i>&nbsp;&nbsp;' . $_SESSION['documentoAdmin'] . '
                              </a>
                           ';
          } else if (!$_SESSION['documentoUser'] == "") {
            echo ' 

                              <a href="pedido.php" class="table-cell-td">Pedido</a>
                              <a href="carrito.php" class="table-cell-td">Carrito</a>
                              <a href="#!" class="table-cell-td exit-system">
                              <i class="fa fa-user"></i>&nbsp;&nbsp;' . $_SESSION['documentoUser'] . '
                              </a>
    ...
    <div class="modal-content" id="modal-form-login" style="padding: 15px;">
      ...
      <form action="process/login.php" method="post" role="form" class="FormCatElec" data-form="login">
        <div class="form-group label-floating">
          <label class="control-label"><span class="glyphicon glyphicon-user"></span>&nbsp;Documento</label>
          <input type="text" class="form-control" name="documento-login" required="">
        </div>
        <div class="form-group label-floating">
...
<?php if (isset($_SESSION['documentoUser'])) : ?>
