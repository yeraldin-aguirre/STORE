...
<body id="container-page-index">
    ...
    <?php
    if ($_SESSION['nombreUser'] == "" && $_SESSION['nombreAdmin'] == "") {
        echo '
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 text-center">
                                <article style="margin-top:5%;">
                                    ...
                                    <h3>Registrate</h3>
                                    <p>Registrate como cliente de <span class="tittles-pages-logo">MaxVitrinas</span> en un sencillo formulario para poder completar tus pedidos</p>
