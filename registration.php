                ...
                <!-- <div class="row">
									...
									<div class="col-xs-12">
										<div class="form-group label-floating">
											...
											<input class="form-control" type="text" required name="clie-nit" pattern="[0-9]{1,15}" title="Ingrese su número de documento. Solamente números" maxlength="15">
										</div>
									</div>
									<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
											<label class="control-label"><i class="fa fa-user"></i>&nbsp; Ingrese sus nombre</label>
											<input class="form-control" type="text" required name="clien-nomb" title="Ingrese sus nombres (solamente letras)" pattern="[a-zA-Z ]{1,50}" maxlength="50">
										</div>
									</div>
									<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
