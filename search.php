  ...
  <section id="store">
    ...
    <div class="container">
      <div class="page-header">
        <h1>BÚSQUEDA DE PRODUCTOS <small class="tittles-pages-logo">MaxVitrinas</small></h1>
      </div>
          ...
          <div class="row">
            ...
            ?>
                <div class="col-xs-12 col-sm-6 col-md-4">
                  <div class="thumbnail">
                    <img src="./assets/img-products/<?php if ($prod['Imagen'] != "" && is_file("./assets/img-products/" . $prod['Imagen'])) {
                                                      echo $prod['Imagen'];
                                                    } else {
                                                      echo "default.png";
                                                    } ?>
