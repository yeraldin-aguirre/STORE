...
<body id="container-page-configAdmin">
  ...
  <section id="prove-product-cat-config">
    <div class="container">
      ...
      <ul class="nav nav-tabs nav-justified" style="margin-bottom: 15px;">
        ...
        <li>
          <a href="configAdmin.php?view=reportSells">
            <i class="fa fa-flag" aria-hidden="true"></i> &nbsp; Reportes
          </a>
        </li>
        <li>
      ...
      <?php
      $content = $_GET['view'];
      $WhiteList = ["product", "productlist", "productinfo", "provider", "providerlist", "providerinfo", "customerlist", "category", "categorylist", "categoryinfo", "admin", "adminlist", "order", "reportSells", "reportClie", "bank", "account"];
      if (isset($content)) {
